...
1. **`/mobile-app`**
   ...
   - Features: Google Auth, Receipt upload, OCR auto-fill, Dark mode.
...
Please refer to the detailed documentation for instructions on setting up Firebase, running the apps locally, and deploying to production:
